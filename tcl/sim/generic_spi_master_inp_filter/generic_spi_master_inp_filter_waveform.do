...
add wave -noupdate /generic_spi_master_inp_filter_tb/STRBI
add wave -noupdate /generic_spi_master_inp_filter_tb/STRBO
add wave -noupdate -divider Voter
add wave -noupdate /generic_spi_master_inp_filter_tb/DUT/sync_ffs
add wave -noupdate /generic_spi_master_inp_filter_tb/DUT/voter_ffs
