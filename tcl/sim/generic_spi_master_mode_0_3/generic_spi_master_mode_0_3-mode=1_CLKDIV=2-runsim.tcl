...
##
## @file:           generic_spi_master_mode_0_3-mode=1_CLKDIV=2-runsim.tcl
## @date:           2021-03-28
##
...
vsim -novopt -gDO_ALL_TEST=true -gTCLK_NS=${TCLK_NS} -gCLK_DIV2=${CLKDIV2} -gSPI_MODE=1 -t 1ps work.generic_spi_master_mode_0_3_tb
