...
##
## @file:           generic_spi_master_mode_0_3-mode=2_CLKDIV=3-runsim.tcl
## @date:           2021-03-28
##
...
set TSIM_NS [expr ${TFRM_NS}*${LOOPS} + 100*${TCLK_NS}];    # total sim time


# start simulation, disable optimization
vsim -novopt -gDO_ALL_TEST=true -gTCLK_NS=${TCLK_NS} -gCLK_DIV2=${CLKDIV2} -gSPI_MODE=2 -t 1ps work.generic_spi_master_mode_0_3_tb
