...
add wave -noupdate -expand /generic_spi_master_tb/CSN
...
add wave -noupdate -radix unsigned -childformat {{/generic_spi_master_tb/DUT/sck_clk_gen_cnt(1) -radix unsigned} {/generic_spi_master_tb/DUT/sck_clk_gen_cnt(0) -radix unsigned}} -subitemconfig {/generic_spi_master_tb/DUT/sck_clk_gen_cnt(1) {-height 18 -radix unsigned} /generic_spi_master_tb/DUT/sck_clk_gen_cnt(0) {-height 18 -radix unsigned}} /generic_spi_master_tb/DUT/sck_clk_gen_cnt
...
add wave -noupdate -radix unsigned /generic_spi_master_tb/DUT/cs_cntr_cnt
...
WaveRestoreCursors {{Cursor 2} {170000 ps} 0}
